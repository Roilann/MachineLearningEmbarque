...
E_dataset = np.array_split(E_raw_dataset, len(raw_dataset) // 100)
Y_dataset = np.array_split(Y_raw_dataset, len(raw_dataset) // 100)
...
model = tf.keras.models.Sequential([
    tf.keras.layers.Dense(100, activation='relu', input_shape=(E_train_dataset.shape[1], E_train_dataset.shape[2])),
